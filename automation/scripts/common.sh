...
load_env() {
  ...
  export PW_TEST_TARGETS="${PW_TEST_TARGETS:-auto-smoke}"
  export PW_FULL_TEST_TARGETS="${PW_FULL_TEST_TARGETS:-auto-all}"
  export FULL_SWEEP_EVERY_CYCLES="${FULL_SWEEP_EVERY_CYCLES:-10}"
